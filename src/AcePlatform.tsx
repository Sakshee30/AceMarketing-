...
type AppTab='Launchpad'|'Overview'|'AdSync'|'Funnel'|'Events'|'Diagnostics'|'Sites'|'Live Sync'|'Offline Attribution'|'Journeys'|'Identity'|'Models'|'Attribution'|'Reports'|'Enrich'|'Behavior'|'Feed'|'Agents'|'Calls'|'Meetings'|'Feedback'|'Approvals'|'Ask Ace'|'Integrations'|'Audiences'|'Monitoring'|'Alerts'|'Developers'|'Settings'
