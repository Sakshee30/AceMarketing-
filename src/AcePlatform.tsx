...
type AppTab='Launchpad'|'Overview'|'AdSync'|'Funnel'|'Events'|'Live Sync'|'Offline Attribution'|'Journeys'|'Identity'|'Attribution'|'Enrich'|'Behavior'|'Feed'|'Agents'|'Ask Ace'|'Integrations'|'Audiences'|'Monitoring'|'Settings'
