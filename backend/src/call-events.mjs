...
export const normalizeCallEvent=input=>{
  ...
  return {
    ...
    keyword:source.keyword||source.searchKeyword||source.searchTerm?String(source.keyword||source.searchKeyword||source.searchTerm).slice(0,300):null,
    creative:source.creative||source.creativeName||source.adCreative||source.adName?String(source.creative||source.creativeName||source.adCreative||source.adName).slice(0,300):null,
    adGroup:source.adGroup||source.adGroupName||source.adset||source.adSet?String(source.adGroup||source.adGroupName||source.adset||source.adSet).slice(0,300):null,
