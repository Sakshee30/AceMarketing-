...
function Routing(){
 ...
 return <><PageHead crumb="Conversion / Routing" title="Lead routing" sub="Route each lead to the right sales queue using stitched journey, intent, CRM and conversation context." action="View recent matches" onAction={openRecent}/>
...
function FollowUps(){
 ...
 return <><PageHead crumb="Conversion / Follow-ups" title="Follow-up operations" sub="Keep qualified leads from going cold by turning stalled journey states into prioritized next actions." action="Open call operations" onAction={()=>window.dispatchEvent(new CustomEvent('ace-app-tab',{detail:'Calls'}))}/>
...
function Feedback(){
 ...
 return <><PageHead crumb="Conversion / Feedback" title="Feedback agent" sub="Collect post-interaction feedback, detect objections and route insights back into sales and marketing workflows." action="Configure feedback agent" onAction={()=>window.dispatchEvent(new CustomEvent('ace-app-tab',{detail:'Agents'}))}/>
