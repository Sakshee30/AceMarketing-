...
export const api = {
  ...
  matchQuality: () => request('/match-quality'),
  ...
  voiceScheduler: () => request('/voice-scheduler'),
  createVoiceScheduler: (payload: Record<string, unknown>) => request('/voice-scheduler', { method: 'POST', body: JSON.stringify(payload) }),
  ...
  validateChatgptAds: (payload: Record<string,unknown>) => request('/chatgpt-ads/validate',{method:'POST',body:JSON.stringify(payload)}),
  sendChatgptAds: (payload: Record<string,unknown>) => request('/chatgpt-ads/send',{method:'POST',body:JSON.stringify(payload)}),
